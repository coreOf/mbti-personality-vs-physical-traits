...
**H0:** There is no association between the individual personality trait and posture.

**H1:** There is an association between the individual personality trait and posture.
...
p-value = 0.001072 \< significance-level = 0.05

### Conclusion

The p-value of the Chi-squared test is lower than the significance level, therefore, we reject the
null hypothesis and conclude that there is a significant correlation between an individual's
personality type and their posture. It is important to note that the Chi-squared approximation may
not be correct as our sample size is relatively small and our contingency table is large and data is
sparse. We can try and remedy this by aggregating the posture types into two categories: GOOD and
BAD.
...
Out of the 4 personality traits, only the extroversion/introversion trait passes the chi-squared
test on the significance level of 0.05. We reject the null hypothesis for the
extroversion/introversion personality trait and conclude that there is a significant connection
between an individual's extrovertedness and their posture.

If we try and visualize the extroversion scores for each posture type, it is apparent that
extroverted individuals tend to have better posture.
...
H0: There is no difference in the distribution of the Feeling variable between men and women.

H1: There is a difference in the distribution of the Feeling variable between men and women.
...
print(chi_sq_test)
```
p-value = 0.0002972 > significance level = 0.05
...
H0: The proportion of individuals classified as Feeling is the same for men and women.

H1: The proportion of individuals classified as Feeling is higher for women compared to men.
...
proportion_test
```
p-value = 6.334e-05 < significance level = 0.05 
